...
class Option{
    private: 
        ...
        Button *soundSetting = new OptionScreenButton(Button::SOUNDSETTING, 1.5);
        Button *homeReturn = new OptionScreenButton(Button::HOMERETURN, 1.5);
        Button *gameReturn = new OptionScreenButton(Button::GAMERETURN, 1.5);
        Button *menuSetting = new OptionScreenButton(Button::MENUSETTING, 1.5);
        Grid *_grid= new Grid(4,4);
